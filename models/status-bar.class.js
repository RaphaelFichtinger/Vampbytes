class StatusBar extends DrawableObject {
    ...
    IMAGES = [
        'img/statusbars/green/0.png',
        'img/statusbars/green/20.png',
        'img/statusbars/green/40.png',
        'img/statusbars/green/60.png',
        'img/statusbars/green/80.png',
        'img/statusbars/green/100.png'
    ];
